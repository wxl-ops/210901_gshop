<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="shopShow=!shopShow">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="supportShow=!supportShow">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">{{info.supports[0].name}}</span>
          </span>
          <span class="activity-content ellipsis">{{info.supports[0].content}}</span></div>
      </div>
      <div class="discounts-right"> {{info.supports.length}} 个优惠</div>
    </div>
    <transition-group name="fade">
      <div class="shop-brief-modal" key="1" v-show="shopShow">
      ...
      <div class="activity-sheet" key="2" v-show="supportShow">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="supportClasses[sup.type]" v-for="sup in info.supports" :key="sup.content">
            <span class="content-tag">
              <span class="mini-tag">{{sup.name}}</span>
            </span>
              <span class="activity-content">{{sup.content}}</span>
            </li>
          </ul>
