  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          ...
          <span class="block positive" :class="{'active':selectType === 0}" @click="setSelectType(0)">
            满意
            <span class="count">{{totalPleased}}</span>
          </span>
          <span class="block negative" :class="{'active':selectType === 1}" @click="setSelectType(1)">
            不满意
            <span class="count">{{ratings.length-totalPleased}}</span>
          </span>
        </div>
        <div class="switch" :class="{'on': this.onlyShowText}">
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(rating, index) in toggleRatings" :key="index">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="className[rating.rateType]"></span>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        className:['icon-thumb_up','icon-thumb_down'],
        //存储要显示全部，满意还是不满意，全部是2，满意是0，不满意是1
        selectType:2,
        //存储布尔值确定是否只显示有内容的评价
        onlyShowText:false
      }
    ...
    computed: {
      ...mapState('shop',['ratings','info']),
      ...mapGetters('shop',['totalPleased']),
      toggleRatings(){
